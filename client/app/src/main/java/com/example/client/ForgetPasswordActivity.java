...
public class ForgetPasswordActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobSDK.init(this,"31f7e3f50f5d3","5b3562f11008844243af420fb84bd9e6");
    ...
    public void ForgetPasswordRequest(final String username, final String telenum){
        //请求地址
        String url = "http://81.68.74.65:8080/server/ForgetPasswordServlet";
    ...
    private void alterWarning() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SMSSDK.getVerificationCode(country, phone);
                //做倒计时操作
                Toast.makeText(ForgetPasswordActivity.this, "已发送" + which, Toast.LENGTH_SHORT).show();
                btn_check.setEnabled(false);
                btn_submit.setEnabled(true);
                tm = new Timer();
                tt = new TimerTask() {
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() { //设置取消按钮
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(ForgetPasswordActivity.this, "已取消" + which, Toast.LENGTH_SHORT).show();
            }
        });
        //参数都设置完成了，创建并显示出来
        builder.create().show();
